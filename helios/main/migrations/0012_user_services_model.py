...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Service.oauth'
        db.delete_column('main_service', 'oauth_id')

        # Deleting field 'Service.app_name'
        db.delete_column('main_service', 'app_name')

        # Adding field 'Service.app'
        db.add_column('main_service', 'app', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.ServiceApp']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Service.oauth'
        db.add_column('main_service', 'oauth', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.OAuthSetting']), keep_default=False)

        # Adding field 'Service.app_name'
        db.add_column('main_service', 'app_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Deleting field 'Service.app'
        db.delete_column('main_service', 'app_id')
