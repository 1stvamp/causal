...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RequestToken.oauth_verify'
        db.add_column('main_requesttoken', 'oauth_verify', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RequestToken.oauth_verify'
        db.delete_column('main_requesttoken', 'oauth_verify')
