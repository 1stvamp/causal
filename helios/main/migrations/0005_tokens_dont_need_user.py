...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RequestToken.user'
        db.delete_column('main_requesttoken', 'user_id')


    def backwards(self, orm):
        
        # Adding field 'RequestToken.user'
        db.add_column('main_requesttoken', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)
