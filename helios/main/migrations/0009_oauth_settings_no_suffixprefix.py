...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OAuthSetting.default_api_suffix'
        db.delete_column('main_oauthsetting', 'default_api_suffix')

        # Deleting field 'OAuthSetting.default_api_prefix'
        db.delete_column('main_oauthsetting', 'default_api_prefix')


    def backwards(self, orm):
        
        # Adding field 'OAuthSetting.default_api_suffix'
        db.add_column('main_oauthsetting', 'default_api_suffix', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'OAuthSetting.default_api_prefix'
        db.add_column('main_oauthsetting', 'default_api_prefix', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)
