...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OAuthSetting.name'
        db.add_column('main_oauthsetting', 'name', self.gf('django.db.models.fields.CharField')(default='twitter', max_length=255), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'OAuthSetting.name'
        db.delete_column('main_oauthsetting', 'name')
