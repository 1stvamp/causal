...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Service.name'
        db.delete_column('main_service', 'name')


    def backwards(self, orm):
        
        # Adding field 'Service.name'
        db.add_column('main_service', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)
