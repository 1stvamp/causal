...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserService.setup'
        db.add_column('main_userservice', 'setup', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserService.setup'
        db.delete_column('main_userservice', 'setup')
