...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RequestToken.oauth_token_secret'
        db.alter_column('main_requesttoken', 'oauth_token_secret', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Changing field 'RequestToken.oauth_token'
        db.alter_column('main_requesttoken', 'oauth_token', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'RequestToken.oauth_token_secret'
        db.alter_column('main_requesttoken', 'oauth_token_secret', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'RequestToken.oauth_token'
        db.alter_column('main_requesttoken', 'oauth_token', self.gf('django.db.models.fields.CharField')(max_length=255))
