...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OAuthSetting.callback_url_base'
        db.add_column('main_oauthsetting', 'callback_url_base', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OAuthSetting.callback_url_base'
        db.delete_column('main_oauthsetting', 'callback_url_base')
