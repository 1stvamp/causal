...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceApp.oauth'
        db.alter_column('main_serviceapp', 'oauth_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.OAuthSetting'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'ServiceApp.oauth'
        db.alter_column('main_serviceapp', 'oauth_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.OAuthSetting']))
