...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserService.share'
        db.add_column('main_userservice', 'share', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserService.share'
        db.delete_column('main_userservice', 'share')
