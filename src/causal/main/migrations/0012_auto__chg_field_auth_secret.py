...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Auth.secret'
        db.alter_column('main_auth', 'secret', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Auth.secret'
        db.alter_column('main_auth', 'secret', self.gf('django.db.models.fields.CharField')(max_length=255))
