...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RequestToken.created'
        db.alter_column('main_requesttoken', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Adding field 'ServiceApp.enable'
        db.add_column('main_serviceapp', 'enable', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'RequestToken.created'
        db.alter_column('main_requesttoken', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Deleting field 'ServiceApp.enable'
        db.delete_column('main_serviceapp', 'enable')
