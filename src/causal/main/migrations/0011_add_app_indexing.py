...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'UserService', fields ['app', 'user']
        db.create_unique('main_userservice', ['app_id', 'user_id'])

        # Adding index on 'ServiceApp', fields ['module_name']
        db.create_index('main_serviceapp', ['module_name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'UserService', fields ['app', 'user']
        db.delete_unique('main_userservice', ['app_id', 'user_id'])

        # Removing index on 'ServiceApp', fields ['module_name']
        db.delete_index('main_serviceapp', ['module_name'])
